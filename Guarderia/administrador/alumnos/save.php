...
if ($result->num_rows == 0) { // Solo inserta si no existe la matrícula
    ...
    $sql = "INSERT INTO alumnos (matricula, nombre, edad, direccion, tutor, celular, tipo_sangre, password, foto) VALUES ('$matricula', '$nombre', '$edad', '$direccion', '$tutor', '$celular','$tipo_sangre','$password','$imagen_url')";
