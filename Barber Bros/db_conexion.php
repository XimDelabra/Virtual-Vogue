...
define('DB_NAME', 'barberia');  // Cambiado a 'users'
...
try {
    ...
    // Establece el modo de errores en PDO para que arroje excepciones
     ...
     <div class='card-header'>
      ...
      <div class='card-body'>
        ...
        <h6 align=center>
            ...
            Verifique el nombre de su | base de datos | y detalles de conexión.<br> 
            Error: " . $e->getMessage() . "
            </font></i></strong>
        </h6>
      </div>
